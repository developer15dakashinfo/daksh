      ...
      <footer className="bg-[#0a0a0a] py-4 text-gray-400">
        <div className="container mx-auto px-6 py-14 flex flex-col lg:flex-row gap-20">
          <div className="text-start relative pt-14">
            <div className="flex flex-row gap-20 sm:gap-20 md:gap-24 lg:gap-24">
              ...
              <div className="flex flex-col items-start">
                {words.map((word, index) => {
                  ...
                  return (
                    <span
                      key={index}
                      className={`text-5xl sm:text-5xl md:text-6xl lg:text-[65px] font-bold transition-all duration-800 sm:mb-3 mb-3 md:mb-4 lg:mb-4 ${
          ...
          <div className="lg:w-8/12 md:w-8/12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 md:pl-20 lg:pl-20">
            ...
            <div className="px-4 lg:col-span-2">
              ...
              <address className="text-gray-400 text-sm leading-6 space-y-2">
                <p>
                  <span className="font-bold text-gray-300">Office:</span> G-2,
                  G.S. Apartment, Near Sunshine Honda Showroom, Jaipur,
                  Rajasthan.
                </p>
                <p>
