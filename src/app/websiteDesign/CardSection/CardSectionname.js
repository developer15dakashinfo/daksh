          ...
          <div className="">
            <div className="grid md:grid-cols-2 gap-12">
              <div className="text-left">
                ...
                <button
                  type="button"
                  className="mt-6 px-5 py-2.5 rounded-full text-white text-sm tracking-wider font-medium border border-current outline-none bg-blue-700 hover:bg-blue-800 active:bg-blue-700"
                >
                  Get started
                </button>
              </div>
