...
const Testimonials = ({ title, content }) => {
  return (
    <div className="">
            ...
            <div>
              <div className="mt-4 space-y-12">
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-medium leadi text-start ">Advanced Learning Algorithms</h4>
                    <p className="mt-2 text-start ">Discover our improved learning algorithms that adapt to your preferences and provide even more personalized learning suggestions.</p>
                  </div>
                </div>
                <div className="flex">
                  <div className="flex-shrink-0">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-medium leadi text-start ">Interactive Learning Resources</h4>
                    <p className="mt-2 text-start ">Access an extensive library of interactive resources that make your learning journey engaging and interactive.</p>
                  </div>
                </div>
                <div className="flex">
                  <div className="flex-shrink-0">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-medium leadi text-start ">Enhanced Video Streaming</h4>
                    <p className="mt-2 text-start ">Experience seamless video integration with enhanced streaming capabilities, providing a better and more uninterrupted learning experience.</p>
                  </div>
                </div>
                <div className="flex">
                  <div className="flex-shrink-0">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-medium leadi text-start ">Advanced Quiz Generation </h4>
                    <p className="mt-2 text-start ">Take your knowledge testing to the next level with advanced quiz generation, providing more customization options for your quizzes.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div>
            <h2 className="text-3xl font-bold text-center sm:text-5xl">Our Partners</h2>
          </div><br/>
      <Slider
            width="250px"
            duration={8}
        ...
        >
            <Slider.Slide>
                <img src="https://www.antiersolutions.com/wp-content/uploads/2023/05/web3auth-logo.svg" alt="any" className='w-36' />
            </Slider.Slide>
            <Slider.Slide>
                <img src="https://www.antiersolutions.com/wp-content/uploads/2024/08/boba-new.png.webp" alt="any2" className='w-36' />
            </Slider.Slide>
            <Slider.Slide>
                <img src="https://www.antiersolutions.com/wp-content/uploads/2022/12/logotype.bfb3381.png" alt="any3" className='w-36' />
            </Slider.Slide>
            <Slider.Slide>
                <div>
                <img src="https://www.antiersolutions.com/wp-content/uploads/2023/05/zeeve.png" alt="any3" className='w-36' />
                </div>
            </Slider.Slide>
        </Slider>
<br/>
        ...
        >
            ...
            <Slider.Slide>
                <img src="https://www.antiersolutions.com/wp-content/uploads/2024/10/hashlock_logo.svg" alt="any3" className='w-36' />
            </Slider.Slide>
            <Slider.Slide>
                <img src="https://www.antiersolutions.com/wp-content/uploads/2024/04/Clip01.svg" alt="any3" className='w-36' />
            </Slider.Slide>
