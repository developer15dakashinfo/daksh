          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            <div className="lg:pr-8 lg:pt-4">
              <div className="lg:max-w-lg">
                <h2 className="text-base font-semibold leading-7 text-blue-600">Produce faster</h2>
            ...
            <img
              src="https://www.orientsoftware.com/Themes/Content/Images/blog/2023-07-24/hire-mobile-app-developer-different-ways.jpg"
...
export default ContentSectionHome5;
