            ...
            <div className="bg- text-white py-20 mt-72 mb-40">
              ...
              <div className="container mx-auto flex flex-col md:flex-row items-center  md:my-10">
                <div className="flex flex-col w-full lg:w-2/3 justify-center text-center p-8">
                  ...
                  <a
                    href="#"
                    className="bg-transparent hover:bg-yellow-300 text-yellow-300 mt-4 hover:text-black rounded shadow hover:shadow-lg py-2 px-4 border border-yellow-300 hover:border-transparent"
                  >
                    Let's Connect
                  </a>
                </div>
                <div className="p-8 mt-12 mb-6 md:mb-0 md:mt-0 ml-0 md:ml-12 lg:w-2/3  justify-center">
                  <div className="h-48 flex flex-wrap gap-10 content-center">
                    <div>
                      <img
                        className="inline-block mt-28 hidden xl:block w-60 h-80 rounded-full"
                        src="https://www.dotsquares.com/img/service-images/expert3.jpg"
                      />
                    </div>
                    <div>
                      <img
                        className="inline-block mt-24 md:mt-0 p-8 md:p-0  w-60 h-96 rounded-full"
                        src="https://www.dotsquares.com/img/service-images/expert4.jpg"
                      />
                    </div>
                  </div>
                </div>
