...
<div className=" max-w-[1600px]  mx-auto ">
  ...
  <div className="pb-20 px-8 sm:px-8 md:px-20 lg:px-40">
    <div className="flex flex-col sm:flex-row gap-12 sm:gap-20 max-w-full mx-auto">
      
      <div className="w-full sm:w-5/12 border-b sm:border-b-0 sm:border-r border-gray-300 pb-4 sm:pb-0 sm:pr-8 md:pr-20">
      ...
      <div className="w-full sm:w-8/12 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-8 items-start">
        <img
        ...
        />
        <img
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQy3II6yB-VsTTZjLEjAkOLi5G0brAlIPlZ5A&s"
