...
const Featuredsection = () => {
  ...
  return (
  <>
  <div className="max-w-[1600px] mx-auto my-8 xl:px-20 lg:px-20 md:px-10 px-10 py-10 ">
  ...
  <ul className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 p-x xl:p-5">
    <li className="relative bg-white flex flex-col justify-between border rounded-3xl shadow-md hover:shadow-primary-400">
      <a className="relative" href="/tool/writey-ai">
        <div className="relative w-full aspect-video">
          <img className="rounded-3xl w-full h-full object-cover" src="https://images.unsplash.com/photo-1511467687858-23d96c32e4ae?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHw1fHxrZXlib2FyZHxlbnwwfDB8fHwxNjk5NTI1MDAzfDA&ixlib=rb-4.0.3&q=80&w=1080" alt="Writey A.I" loading="lazy" />
    ...
    <li className="relative bg-white flex flex-col justify-between border rounded-3xl shadow-md hover:shadow-primary-400">
      <a className="relative" href="/tool/writemeai">
        <div className="relative w-full aspect-video">
          <img className="rounded-3xl w-full h-full object-cover" src="https://images.unsplash.com/photo-1529236183275-4fdcf2bc987e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHwxfHxrZXlib2FyZHxlbnwwfDB8fHwxNjk5NTI1MDAzfDA&ixlib=rb-4.0.3&q=80&w=1080" alt="WriteMe.ai" loading="lazy" />
          <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-b from-gray-800 to-gray-500 text-white">
    ...
    <li className="relative bg-white flex flex-col justify-between border rounded-3xl shadow-md hover:shadow-primary-400">
      <a className="relative" href="/tool/publer">
        <div className="relative w-full aspect-video">
          <img className="rounded-3xl w-full h-full object-cover" src="https://images.unsplash.com/photo-1586776977607-310e9c725c37?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHwxM3x8a2V5Ym9hcmR8ZW58MHwwfHx8MTY5OTUyNTAwM3ww&ixlib=rb-4.0.3&q=80&w=1080" alt="Publer" loading="lazy" />
          <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-b from-gray-800 to-gray-500 text-white">
    ...
    <li className="relative bg-white flex flex-col justify-between border rounded-3xl shadow-md hover:shadow-primary-400">
      <a className="relative" href="/tool/anyword">
        <div className="relative w-full aspect-video">
          <img className="rounded-3xl w-full h-full object-cover" src="https://images.unsplash.com/photo-1574012716378-0ca6f4c18c08?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHw2fHxrZXlib2FyZHxlbnwwfDB8fHwxNjk5NTI1MDAzfDA&ixlib=rb-4.0.3&q=80&w=1080" alt="Anyword" loading="lazy" />
          <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-b from-gray-800 to-gray-500 text-white">
    ...
    <li className="relative bg-white flex flex-col justify-between border rounded-3xl shadow-md hover:shadow-primary-400">
      <a className="relative" href="/tool/blogseo-ai">
        <div className="relative w-full aspect-video">
          <img className="rounded-3xl w-full h-full object-cover" src="https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHw4fHxrZXlib2FyZHxlbnwwfDB8fHwxNjk5NTI1MDAzfDA&ixlib=rb-4.0.3&q=80&w=1080" alt="BlogSEO AI" loading="lazy" />
          <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-b from-gray-800 to-gray-500 text-white">
    ...
    <li className="relative bg-white flex flex-col justify-between border rounded-3xl shadow-md hover:shadow-primary-400">
      <a className="relative" href="/tool/typewise">
        <div className="relative w-full aspect-video">
          <img className="rounded-3xl w-full h-full object-cover" src="https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHw4fHxrZXlib2FyZHxlbnwwfDB8fHwxNjk5NTI1MDAzfDA&ixlib=rb-4.0.3&q=80&w=1080" alt="Typewise" loading="lazy" />
          <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-b from-gray-800 to-gray-500 text-white">
