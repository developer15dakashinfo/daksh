...
// <nav  className={`bg-black text-white px-20 py-5 flex justify-between items-center fixed top-0 left-0 w-full z-50 shadow-md transition-all duration-500 ${
//         isScrolled ? "rounded-lg transform translate-y-0" : "rounded-none"
//       }`}>
...
//         <a
//           href={item.link}
//           className="text-white font-[500] text-[16px] hover:text-gray-400 transition-colors relative flex items-center"
//         >
//           {item.label}
//           {item.dropdownItems && (
//             <>
...
//         {item.dropdownItems && (
//           <div
//             className={`fixed top-[80px] left-0 w-full bg-black py-6 shadow-lg z-50 transition-all duration-1000 ease-in-out ${
//               showDropdown && activeDropdown === index
//                 ? "opacity-100 transform translate-y-0"
//                 : "opacity-0 transform -translate-y-5"
//             }`}
//           >
//             <div className="container mx-auto grid grid-cols-4 gap-8 text-sm px-40">
//               {item.dropdownItems.map((dropdownItem, i) => (
//                 <div key={i} className="space-y-4 text-center">
//                   <h3 className="font-medium text-white pt-14">
//                     {dropdownItem.heading}
//                   </h3>
//                   <ul>
//                     {dropdownItem.items.map((subItem, j) => (
//                       <li key={j} className="hover:text-gray-300 py-2 font-semibold">
