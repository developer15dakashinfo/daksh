      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-16">
        ...
        <div>
          <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" viewBox="0 0 512 512">
            ...
            <path fill="#1e88e5" d="M265.472 348.896c-2.816 2.08-6.144 3.104-9.472 3.104s-6.656-1.024-9.472-3.104L0 192v288c0 17.664 14.336 32 32 32h448c17.664 0 32-14.336 32-32V192L265.472 348.896z" data-original="#1e88e5" />
...
<div>
  <div className="relative m-16">
    ...
    <div className="black_border p-8 border border-black">
      The
      <span className="font-mono text-black font-bold mx-2">message</span>
      Our mission is to become a globally respected software development enterprise,
       providing a range of development, hosting and marketing solutions all under one roof. 
       With our bespoke services we can deliver a tailored service 
    </div>
  </div>
  <div className="relative m-16">
    ...
    <div className="p-8 border border-black black_border bg-white rounded-xl z-20">
      The
      <span className="font-mono text- font-bold mx-2">message</span>
      It’s our vision to help all businesses grow with the most innovative technology 
      in the market. With our expertise and guidance across a range of industries,
       we can help put any brand on the map!
    </div>
  </div>
</div>
...
<br/><br/>
<div className="bg-gray-700 p-4 pb-10 ">
  <div className="max-w-7xl mx-auto h-max px-6 md:px-12 xl:px-6">
    <div className="md:w-2/3 lg:w-1/2">
      
      <h2 className="my-8 text-2xl text-start font-bold text-white md:text-4xl">How we work?</h2>
...
<div>
  \
  <div className="relative overflow-hidden rounded-2xl m-16">
    <div className="absolute inset-0">
      <img src="https://images.unsplash.com/photo-1637273045211-df6d2e06b26e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHwxMXx8dGlnZXJ8ZW58MHwwfHx8MTcyMDg4OTc2MHww&ixlib=rb-4.0.3&q=80&w=1925&h625" alt="Background Image" className="object-cover object-center w-full h-full" />
    </div>
    <div className="relative px-16 py-8 sm:px-8 lg:px-16 lg:py-14">
      <div className="md:flex md:items-center md:space-x-12 lg:space-x-24">
        ...
        <div className="mt-10 md:mt-0">
          <a className="inline-flex items-center px-9 py-3.5 mt-5 text-base font-bold text-white transition-all duration-200 bg-orange-500 border border-transparent focus:outline-none focus:ring-2 focus:ring-offset-2 focus:bg-orange-500 hover:bg-opacity-90 rounded-xl no-underline" href="#">Contact Us
          </a>
        </div>
      </div>
    </div>
